...
static const empiric_t lmk05318_rom_dpll_empiric[] =
{
    ...
    {0x010580, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control  ?DPLL_REF_CYCSLIP_OFFSET (MSB)
    {0x010601, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control  ?DPLL_REF_CYCSLIP_OFFSET
    {0x01072a, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control  ?DPLL_REF_CYCSLIP_OFFSET
    {0x010805, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control  ?DPLL_REF_CYCSLIP_OFFSET
    {0x0109f2, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control  ?DPLL_REF_CYCSLIP_OFFSET
    {0x010a00, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control  ?DPLL_REF_CYCSLIP_OFFSET (LSB) = 5000000000
    ...
    {0x010e02, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_FILTER_SCALAR (MSB)
    {0x010fa6, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_FILTER_SCALAR (LSB) = 678
    ...
    {0x011316, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_LOOP_GAIN=22
    {0x011416, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_LOOP_GAIN_FL1=22
    {0x011516, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_LOOP_GAIN_FL2=22
    ...
    {0x011c1e, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_LPF0_GAIN2_FL=20
    {0x011d1e, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_LPF1_GAIN2_FL=20
    ...
    {0x01280a, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_QUANT=10
    {0x01290a, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_QUANT_FL1=10
    {0x012a0a, REG_OVERRIDE | REG_DPLL},                     // DPLL Loop Filter  ?DPLL_REF_QUANT_FL2=10
    ...
    {0x013f03, REG_OVERRIDE | REG_DPLL},                     // DPLL Reference Control   ?DPLL_REF_ORDER=3
    {0x014000, REG_OVERRIDE | REG_DPLL},                     // DPLL DCO Lock Detection
    {0x01410a, REG_OVERRIDE | REG_DPLL},                     // DPLL DCO Lock Detection  ?DPLL_REF_LOOPFILT_CLK_DIV=10
