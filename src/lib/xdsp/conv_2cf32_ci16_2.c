...
#ifdef WVLT_AVX2
#define TEMPLATE_FUNC_NAME conv_2cf32_ci16_avx2
VWLT_ATTRIBUTE(optimize("-O3"), target("avx2"))
#include "templates/conv_2cf32_ci16_avx2.t"
DECLARE_TR_FUNC_2_1(conv_2cf32_ci16_avx2)
#endif

#ifdef WVLT_NEON
#define TEMPLATE_FUNC_NAME conv_2cf32_ci16_neon
VWLT_ATTRIBUTE(optimize("-O3"))
#include "templates/conv_2cf32_ci16_neon.t"
DECLARE_TR_FUNC_2_1(conv_2cf32_ci16_neon)
#endif
...
conv_function_t conv_get_2cf32_ci16_c(generic_opts_t cpu_cap, const char** sfunc)
{
    ...
    SELECT_AVX2_FN(fn, fname, tr_conv_2cf32_ci16_avx2, cpu_cap);
    SELECT_NEON_FN(fn, fname, tr_conv_2cf32_ci16_neon, cpu_cap);
