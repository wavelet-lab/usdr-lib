...
#include "templates/conv_ci12_4cf32_avx2.t"
DECLARE_TR_FUNC_1_4(conv_ci12_4cf32_avx2)
#endif

#ifdef WVLT_NEON
#define TEMPLATE_FUNC_NAME conv_ci12_4cf32_neon
VWLT_ATTRIBUTE(optimize("-O3"))
#include "templates/conv_ci12_4cf32_neon.t"
DECLARE_TR_FUNC_1_4(conv_ci12_4cf32_neon)
#endif

conv_function_t conv_get_ci12_4cf32_c(generic_opts_t cpu_cap, const char** sfunc)
{
    const char* fname;
    conv_function_t fn;
...
conv_function_t conv_get_ci12_4cf32()
{
    return conv_get_ci12_4cf32_c(cpu_vcap_get(), NULL);
}
