...
int main(int argc, char** argv)
{
    ...
    srunner_add_suite(sr, conv_3ci16_ci16_suite());
    ...
    //
#else
    sr = srunner_create(  conv_3cf32_ci16_suite());
    srunner_add_suite(sr, conv_ci16_3cf32_suite());
    srunner_add_suite(sr, conv_3ci16_ci16_suite());
    srunner_add_suite(sr, conv_ci16_3ci16_suite());
#endif
