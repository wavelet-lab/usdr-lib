...
{
    return generic_get_fn(o, log, conv_get_ci16_4cf32_c, &last_fn_name);
}
...
Suite * conv_ci16_4cf32_suite(void)
{
    ...
    Suite* s = suite_create("conv_ci16_4cf32");

    ADD_REGRESS_TEST(s, conv_ci16_4cf32_check_simd);
    ADD_PERF_LOOP_TEST(s, conv_ci16_4cf32_speed, 60, 0, 3);
