                        ...
                        unsigned outdatabsz)
{
    ...
    //AVX2
    {
        ...
        for(; i >= 32 * 8; i -= 32 * 8)
        {
            ...
            _mm256_store_si256((__m256i*)outdata_0, out0);
            _mm256_store_si256((__m256i*)outdata_1, out1);
            _mm256_store_si256((__m256i*)outdata_2, out2);
            _mm256_store_si256((__m256i*)outdata_3, out3);
            _mm256_store_si256((__m256i*)outdata_4, out4);
            _mm256_store_si256((__m256i*)outdata_5, out5);
            _mm256_store_si256((__m256i*)outdata_6, out6);
            _mm256_store_si256((__m256i*)outdata_7, out7);
