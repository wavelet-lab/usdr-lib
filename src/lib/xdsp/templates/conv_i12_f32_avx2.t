...
#define CONVERT_I12_F32_BLOCK(reg, dst0, dst1) \
    v0 = _mm256_sllv_epi64(reg, shl_ctrl); \
    v1 = _mm256_srlv_epi64(reg, shr_ctrl); \
    v2 = _mm256_permute4x64_epi64(v1, _MM_SHUFFLE(2,1,0,3)); \
    v3 = _mm256_or_si256(v0, v2); \
    \
    a = _mm256_and_si256(_mm256_slli_epi64(v3, 16), mask0); \
    b = _mm256_and_si256(_mm256_slli_epi64(v3, 12), mask1); \
    c = _mm256_and_si256(_mm256_slli_epi64(v3,  8), mask2); \
    d = _mm256_and_si256(_mm256_slli_epi64(v3,  4), mask3); \
    \
    r0 = _mm256_or_si256(a, b); \
    r1 = _mm256_or_si256(c, d); \
    result = _mm256_or_si256(r0, r1); \
    \
    d0 = _mm256_permute4x64_epi64(result, _MM_SHUFFLE(3, 1, 2, 0)); \
    i0 = _mm256_unpacklo_epi16(zeros,d0); \
    i1 = _mm256_unpackhi_epi16(zeros,d0); \
    \
    dst0 = _mm256_cvtepi32_ps(i0); \
    dst1 = _mm256_cvtepi32_ps(i1); \
    \
    dst0 = _mm256_mul_ps(dst0, scale); \
    dst1 = _mm256_mul_ps(dst1, scale); \
...
// CONVERT_I12_F32_BLOCK end
    ...
    for (; i >= 96; i -= 96)
    {
        u_v8u64_t x0 = {_mm256_load_si256(in256++)};
        u_v8u64_t x1 = {_mm256_load_si256(in256++)};
        u_v8u64_t x2 = {_mm256_load_si256(in256++)};
        ...
        CONVERT_I12_F32_BLOCK(y3, f6, f7);
#if 1
